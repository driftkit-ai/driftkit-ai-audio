...
import ai.driftkit.audio.config.VadConfig;
import ai.driftkit.audio.config.EngineType;
import ai.driftkit.audio.config.ProcessingMode;
import ai.driftkit.audio.config.LanguageCode;
import ai.driftkit.audio.config.DeepgramConfig;
import ai.driftkit.audio.service.AudioSessionManager;
import ai.driftkit.audio.service.AudioConverter;
...
public class MicrophoneListeningTest {
    ...
    private AudioSessionManager createSessionManager(AudioProcessingConfig config) {
        TranscriptionEngineFactory engineFactory = new TranscriptionEngineFactory(config);
